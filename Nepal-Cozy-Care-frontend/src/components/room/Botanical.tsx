...
/**
 * Renders the 3D foliage (stems, leaves, flowers) starting from y = 0 (soil level).
 * Can be plugged directly into ANY planter pot or standalone display!
 */
export function BotanicalFoliage({ kind }: { kind: string }) {
      ...
      <group>
        {[
          ...
          <group key={stemIdx} rotation={[0, stem.angle, 0]}>
            <mesh position={[0.08, stem.height * 0.45, 0]} rotation={[0, 0, -stem.spread * 0.65]} castShadow>
            ...
            {Array.from({ length: 14 }).map((_, leafIdx) => {
              ...
              const posY = frac * stem.height * 0.75
      ...
      <group>
        {[
          ...
          <group key={sIdx} rotation={[0, stem.angle, 0]}>
            <mesh position={[0.06, stem.height * 0.45, 0]} rotation={[0, 0, -stem.tilt]} castShadow>
            ...
            {Array.from({ length: 8 }).map((_, lfIdx) => {
              ...
              const py = frac * stem.height * 0.72
              return (
                <mesh
                  key={lfIdx}
                  geometry={smallLeaf}
      ...
      <group>
        {Array.from({ length: 8 }).map((_, idx) => {
          ...
          return (
            <group key={`leaf_${idx}`} rotation={[0, angle, 0]}>
              <mesh position={[0.22, 0.05, 0]} rotation={[0.2, 0, -0.75]} geometry={broadLeaf} castShadow>
        ...
        {[-0.5, 0.7].map((flowerAngle, fIdx) => (
          <group key={`flower_${fIdx}`} rotation={[0, flowerAngle, 0]}>
            <mesh position={[0.12, 0.35, 0]} rotation={[0, 0, -0.15]} castShadow>
              <cylinderGeometry args={[0.006, 0.008, 0.65, 8]} />
              <meshStandardMaterial color="#477334" />
            </mesh>
            <mesh position={[0.16, 0.68, 0]} rotation={[0, 0, -0.2]} geometry={smallLeaf} castShadow>
              <meshStandardMaterial color="#ffffff" roughness={0.3} side={THREE.DoubleSide} />
            </mesh>
            <mesh position={[0.16, 0.66, 0.015]} rotation={[0, 0, -0.2]}>
        ...
        {Array.from({ length: 12 }).map((_, idx) => {
          ...
          return (
            <group key={idx} rotation={[0, angle, 0]}>
              <mesh
                position={[0.12 + tier * 0.03, tier * 0.04, 0]}
                rotation={[0, 0, -tilt]}
                geometry={snakeLeaf}
  ...
  if (kind === 'jade') {
    return (
      <group>
        ...
        <mesh position={[-0.08, 0.33, 0]} rotation={[0, 0, 0.5]} castShadow>
          <cylinderGeometry args={[0.024, 0.034, 0.25, 10]} />
          <meshStandardMaterial color="#544030" roughness={0.85} />
        </mesh>
        <mesh position={[0.08, 0.35, 0.04]} rotation={[0.3, 0, -0.45]} castShadow>
        ...
        {[
          ...
          <group key={jIdx} position={[px, py, pz]}>
            <mesh castShadow>
              ...
              <meshPhysicalMaterial color="#3d6c48" roughness={0.25} clearcoat={0.5} />
            </mesh>
          </group>
        ))}
      </group>
      ...
      <group>
        ...
        {[0.6, 2.7, 4.8].map((runnerAngle, rIdx) => (
          <group key={`runner_${rIdx}`} rotation={[0, runnerAngle, 0]}>
            <mesh position={[0.28, -0.2, 0]} rotation={[0, 0, -1.2]} castShadow>
              <cylinderGeometry args={[0.004, 0.005, 0.48, 8]} />
              <meshStandardMaterial color="#94b87d" />
            </mesh>
            <mesh position={[0.46, -0.4, 0]} castShadow>
    ...
    return (
      <group>
        {Array.from({ length: 14 }).map((_, idx) => {
          ...
          return (
            <group key={idx} rotation={[0, angle, 0]}>
              <mesh position={[0.25, 0.03, 0]} rotation={[0, 0, -tilt]} geometry={palmLeaflet} scale={[1.2, 1.3, 1.2]} castShadow>
      ...
      <group>
        {Array.from({ length: 6 }).map((_, idx) => {
          ...
          return (
            <group key={`aleaf_${idx}`} rotation={[0, angle, 0]}>
              <mesh position={[0.18, 0.02, 0]} rotation={[0.2, 0, -0.7]} geometry={broadLeaf} castShadow>
        ...
        {[-0.6, 0.8].map((fAngle, fIdx) => (
          <group key={`anth_flower_${fIdx}`} rotation={[0, fAngle, 0]}>
            <mesh position={[0.12, 0.3, 0]} rotation={[0, 0, -0.18]} castShadow>
              <cylinderGeometry args={[0.006, 0.008, 0.58, 8]} />
              <meshStandardMaterial color="#477334" />
            </mesh>
            <mesh position={[0.18, 0.56, 0]} rotation={[0.25, 0, -0.35]} geometry={smallLeaf} castShadow>
              <meshPhysicalMaterial color="#d62828" roughness={0.15} clearcoat={0.8} side={THREE.DoubleSide} />
            </mesh>
            <mesh position={[0.18, 0.56, 0.02]} rotation={[0.2, 0, -0.35]}>
      ...
      <group>
        {[
          ...
          <group key={cIdx} position={[cane.caneX, 0, cane.caneZ]}>
            <mesh position={[0, cane.h * 0.45, 0]} rotation={[cane.lean, 0, -cane.lean]} castShadow>
              <cylinderGeometry args={[0.016, 0.025, cane.h, 10]} />
              <meshStandardMaterial color="#5a4533" roughness={0.8} />
            </mesh>
            <group position={[0, cane.h * 0.92, 0]}>
  ...
  if (kind === 'bonsai') {
    return (
      <group>
        <mesh position={[0, 0.16, 0]} rotation={[0.15, 0, 0.2]} castShadow>
          <cylinderGeometry args={[0.04, 0.075, 0.35, 12]} />
          <meshStandardMaterial color="#4a3628" roughness={0.85} />
        </mesh>
        <mesh position={[-0.08, 0.36, 0]} rotation={[-0.2, 0, -0.4]} castShadow>
          ...
          return (
            <group key={sIdx} rotation={[0, angle, 0]}>
              {Array.from({ length: 8 }).map((_, pIdx) => {
                ...
                const py = -frac * strandLen
                return (
                  <mesh key={pIdx} position={[px, py, 0]} castShadow>
                    <sphereGeometry args={[0.024, 8, 8]} />
                    <meshPhysicalMaterial color="#4d8243" roughness={0.2} clearcoat={0.6} />
                  </mesh>
                )
              })}
            </group>
  ...
  // Default: Monstera Deliciosa foliage
  return (
    <group>
      {[
  ...
  if (kind === 'peacelily') {
    return (
      <group>
        ...
        <group position={[0, 0.47, 0]}>
          <BotanicalFoliage kind="peacelily" />
        </group>
      </group>
    )
  }
    ...
    return (
      <group>
        ...
        <group position={[0, 0.43, 0]}>
          <BotanicalFoliage kind="calathea" />
        </group>
      </group>
    )
  }
  ...
  if (kind === 'anthurium') {
    return (
      <group>
        ...
        <group position={[0, 0.43, 0]}>
          <BotanicalFoliage kind="anthurium" />
        </group>
      </group>
    )
  }
    ...
    return (
      <group>
        ...
        <group position={[0, 0.55, 0]}>
          <BotanicalFoliage kind="dracaena" />
        </group>
      </group>
    )
  }
  ...
  if (kind === 'stringofpearls') {
    return (
      <group>
        ...
        <group position={[0, 0.31, 0]}>
          <BotanicalFoliage kind="stringofpearls" />
        </group>
      </group>
    )
  }
  ...
  return (
    <group>
      ...
      <group position={[0, 0.48, 0]}>
        <BotanicalFoliage kind="monstera" />
      </group>
    </group>
  )
}
